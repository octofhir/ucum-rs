//! FHIR integration for UCUM operations.
//!
//! This module provides integration between the UCUM core library and FHIR,
...
impl FhirQuantity {
    ...
    ///
    /// ```
    /// use octofhir_ucum::fhir::FhirQuantity;
    ///
...
pub fn are_equivalent(a: &FhirQuantity, b: &FhirQuantity) -> Result<bool, FhirError> {
    ...
    let max = a_ucum
        .value
        .abs()
        .max((b_ucum.value * to_f64(factor)).abs());
